...
def fetch_bootstrap(bootstrap_id, work_dir):
    copy_set = [
        "{}/{}.bootstrap.tar.xz".format(work_dir, bootstrap_id),
        "{}/{}.active.json".format(work_dir, bootstrap_id)]
    dest_dir = "{}/bootstrap/".format(work_dir)
